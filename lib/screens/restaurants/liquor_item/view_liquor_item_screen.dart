...
class ViewLiquorItemScreen extends StatefulWidget {
  static const routeName = '/view-liquor-item';

  ViewLiquorItemScreen({Key? key}) : super(key: key);

  @override
  _ViewLiquorItemScreenState createState() => _ViewLiquorItemScreenState();
}

class _ViewLiquorItemScreenState extends State<ViewLiquorItemScreen> {
  bool _isInit = true;
        ...
        children: [
          ...
          Container(
            ...
            child: ClipRRect(
              ...
              child: Image.network(
                ProjectConstant.food_images_path + liquorItem!.image,
                height: 170,
                fit: BoxFit.cover,
              ),
            ),
